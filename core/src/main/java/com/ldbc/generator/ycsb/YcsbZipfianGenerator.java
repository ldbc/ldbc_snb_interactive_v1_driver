 ...
 * SIGMOD 1994.
 */
public class YcsbZipfianGenerator extends Generator<Long>
{
     ...
     */
    // TODO use Range
    public YcsbZipfianGenerator( RandomDataGenerator random, long min, long max, double zipfianConstant )
    {
     ...
     */
    // TODO use Range
    public YcsbZipfianGenerator( RandomDataGenerator random, long min, long max, double zipfianConstant, double zetan )
    {
        super( random );
        items = max - min + 1;
        base = min;
