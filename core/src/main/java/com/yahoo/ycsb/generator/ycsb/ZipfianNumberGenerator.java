 ...
 * SIGMOD 1994.
 */
public class ZipfianNumberGenerator<T extends Number> extends Generator<T>
{
     ...
     */
    public ZipfianNumberGenerator( RandomDataGenerator random, T min, T max, double zipfianConstant )
    {
     ...
     */
    // TODO use Range
    public ZipfianNumberGenerator( RandomDataGenerator random, T min, T max, double zipfianConstant, double zetan )
    {
        super( random );
    ...
    static <T1 extends Number> double zetaStatic( T1 st, T1 n, double theta, double initialsum )
    {
        ...
        for ( T1 i = st; number.lt( i, n ); number.inc( i ) )
        {
