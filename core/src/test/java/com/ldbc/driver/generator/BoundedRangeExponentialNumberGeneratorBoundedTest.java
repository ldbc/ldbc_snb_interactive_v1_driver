...
public class BoundedRangeExponentialNumberGeneratorBoundedTest extends NumberGeneratorTest<Long, Integer>
{
    ...
    {
        // return getGeneratorBuilder().exponentialGenerator( percentile, range
        // ).build();
        // TODO test this too
    ...
    {
        // Histogram<Long, Integer> expectedDistribution = new Histogram<Long,
        // Integer>( 0 );
        // expectedDistribution.addBucket( new NumberRangeBucket<Long>(
        // Range.closedOpen( 0d, 90d ) ), 9 );
        // expectedDistribution.addBucket( new NumberRangeBucket<Long>(
        // Range.closed( 90d, Double.MAX_VALUE ) ), 1 );
