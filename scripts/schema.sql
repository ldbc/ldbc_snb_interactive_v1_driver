...
-- INS 5
CREATE OR REPLACE TABLE Forum_hasMember_Person_Insert_Converted (
    creationDate timestamp with time zone NOT NULL,
    ForumId bigint NOT NULL,
    PersonId bigint NOT NULL
);
...
-- INS 3
CREATE OR REPLACE TABLE Person_likes_Comment_Insert_Converted (
    creationDate timestamp with time zone NOT NULL,
    PersonId bigint NOT NULL,
    CommentId bigint NOT NULL
);
...
-- INS 2
CREATE OR REPLACE TABLE Person_likes_Post_Insert_Converted (
    creationDate timestamp with time zone NOT NULL,
    PersonId bigint NOT NULL,
    PostId bigint NOT NULL
);
...
-- INS 8
CREATE OR REPLACE TABLE Person_knows_Person_Insert_Converted (
    creationDate timestamp with time zone NOT NULL,
    Person1id bigint NOT NULL,
    Person2id bigint NOT NULL
);
