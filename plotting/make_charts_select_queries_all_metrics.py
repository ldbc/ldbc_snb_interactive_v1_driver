...
if arg_count != 4:
	print "4 parameter expected (results_file, start_query, end_query, legend_location left/center/right/none) - %s given"%arg_count
	exit()

filename = sys.argv[1]
start_query_index = int(sys.argv[2])-1
end_query_index = int(sys.argv[3])
legend_location = sys.argv[4]
...
query_data = query_data[start_query_index:end_query_index]
