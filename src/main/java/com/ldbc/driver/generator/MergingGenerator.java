...
// TODO test
public class MergingGenerator<FROM_GENERATE_TYPE_1, FROM_GENERATE_TYPE_2, TO_GENERATE_TYPE> extends Generator<TO_GENERATE_TYPE> {
    private final Iterator<FROM_GENERATE_TYPE_1> original1;
    private final Iterator<FROM_GENERATE_TYPE_2> original2;
    private final Function2<FROM_GENERATE_TYPE_1, FROM_GENERATE_TYPE_2, TO_GENERATE_TYPE> mergeFun;

    MergingGenerator(Iterator<FROM_GENERATE_TYPE_1> original1,
                     Iterator<FROM_GENERATE_TYPE_2> original2,
                     Function2<FROM_GENERATE_TYPE_1, FROM_GENERATE_TYPE_2, TO_GENERATE_TYPE> mergeFun) {
