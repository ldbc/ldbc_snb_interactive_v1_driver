...
public class CompletionTimeMaintenanceThread extends Thread {
            ...
            try {
                ...
                switch (event.type()) {
                    ...
                    case EXTERNAL:
                        ...
                        break;
                    case FUTURE:
                        ThreadedQueuedCompletionTimeService.GlobalCompletionTimeFuture future = ((CompletionTimeEvent.FutureEvent) event).future();
    ...
    private void updateGlobalCompletionTime() {
        ...
        if (null != prevGlobalCompletionTime && newGlobalCompletionTime.lessThan(prevGlobalCompletionTime)) {
            errorReporter.reportError(
                    this,
