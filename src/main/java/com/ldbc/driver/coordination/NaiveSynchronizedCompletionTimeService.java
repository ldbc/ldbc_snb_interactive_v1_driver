...
public class NaiveSynchronizedCompletionTimeService implements CompletionTimeService {
    ...
    public NaiveSynchronizedCompletionTimeService(List<String> peerIds) throws CompletionTimeException {
