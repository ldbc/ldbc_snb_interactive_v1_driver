...
// TODO test
class OperationHandlerRunnableContextInitializer_NEW {
    ...
    OperationHandlerRunnableContextInitializer_NEW(WorkloadStreams.WorkloadStreamDefinition streamDefinition,
                                                   Db db,
