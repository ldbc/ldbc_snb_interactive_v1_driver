...
public class ThreadPoolOperationHandlerExecutor implements OperationHandlerExecutor {
    ...
    public final Future<OperationResult> execute(OperationHandler<?> operationHandler) {
        // TODO find out if taking Future hear means it's not available later during polling, simple test will show
    ...
    @Override
    public final OperationResult poll() throws OperationHandlerExecutorException {
        try {
    ...
    @Override
    public final OperationResult take() throws OperationHandlerExecutorException {
        try {
