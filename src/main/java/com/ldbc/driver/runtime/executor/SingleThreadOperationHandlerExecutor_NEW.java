...
public class SingleThreadOperationHandlerExecutor_NEW implements OperationHandlerExecutor {
    ...
    public SingleThreadOperationHandlerExecutor_NEW(ConcurrentErrorReporter errorReporter, int boundedQueueSize) {
