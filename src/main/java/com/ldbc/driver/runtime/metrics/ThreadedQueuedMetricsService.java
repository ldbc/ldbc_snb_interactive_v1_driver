...
public class ThreadedQueuedMetricsService implements MetricsService {
    ...
    public static ThreadedQueuedMetricsService newInstanceUsingBlockingBoundedQueue(TimeSource timeSource,
                                                                                              ConcurrentErrorReporter errorReporter,
                                                                                              TimeUnit unit,
                                                                                              long maxRuntimeDurationAsNano,
                                                                                              SimpleCsvFileWriter csvResultsLogWriter,
    ...
    private ThreadedQueuedMetricsService(TimeSource timeSource,
                                         ConcurrentErrorReporter errorReporter,
                                         TimeUnit unit,
                                         long maxRuntimeDurationAsNano,
    ...
    private static class ThreadedQueuedMetricsServiceWriter implements ConcurrentMetricsServiceWriter {
        ...
        public WorkloadResultsSnapshot results() throws MetricsCollectionException {
            ...
            try {
                ...
                ThreadedQueuedMetricsEvent event = new ThreadedQueuedMetricsEvent.GetWorkloadResults(workloadResultFuture);
                queueEventSubmitter.submitEventToQueue(event);
