...
public class SimpleOperationMetricsFormatter implements OperationMetricsFormatter {
    ...
    private String formatOneMetricRuntime(String offset, OperationMetricsSnapshot metric) {
        ...
        sb.append(offset).append(offset).append(String.format("%1$-" + padRightDistance + "s", "Count:")).append(INTEGER_FORMATTER.format(metric.runTimeMetric().count())).append("\n");
        sb.append(offset).append(offset).append(String.format("%1$-" + padRightDistance + "s", "Min:")).append(INTEGER_FORMATTER.format(metric.runTimeMetric().min())).append("\n");
        sb.append(offset).append(offset).append(String.format("%1$-" + padRightDistance + "s", "Max:")).append(INTEGER_FORMATTER.format(metric.runTimeMetric().max())).append("\n");
        sb.append(offset).append(offset).append(String.format("%1$-" + padRightDistance + "s", "Mean:")).append(FLOAT_FORMATTER.format(metric.runTimeMetric().mean())).append("\n");
        sb.append(offset).append(offset).append(String.format("%1$-" + padRightDistance + "s", "50th Percentile:")).append(INTEGER_FORMATTER.format(metric.runTimeMetric().percentile50())).append("\n");
        sb.append(offset).append(offset).append(String.format("%1$-" + padRightDistance + "s", "90th Percentile:")).append(INTEGER_FORMATTER.format(metric.runTimeMetric().percentile90())).append("\n");
        sb.append(offset).append(offset).append(String.format("%1$-" + padRightDistance + "s", "95th Percentile:")).append(INTEGER_FORMATTER.format(metric.runTimeMetric().percentile95())).append("\n");
        sb.append(offset).append(offset).append(String.format("%1$-" + padRightDistance + "s", "99th Percentile:")).append(INTEGER_FORMATTER.format(metric.runTimeMetric().percentile99())).append("\n");
        return sb.toString();
    }
}
