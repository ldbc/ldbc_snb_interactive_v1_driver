...
public class WorkloadMetricsManagerOLD
{
    private static Logger logger = Logger.getLogger( WorkloadMetricsManagerOLD.class );
    ...
    private final MetricGroup<ContinuousMetric> runtimeMetrics;
    private final MetricGroup<ContinuousMetric> startTimeDelayMetrics;
    ...
    public WorkloadMetricsManagerOLD()
    {
        this( DEFAULT_DURATION_UNIT, DEFAULT_HIGHEST_EXPECTED_DURATION );
    }

    public WorkloadMetricsManagerOLD( TimeUnit durationUnit )
    {
        this( durationUnit, DEFAULT_HIGHEST_EXPECTED_DURATION );
    }

    public WorkloadMetricsManagerOLD( TimeUnit durationUnit, Duration highestExpectedDuration )
    {
        this.durationUnit = durationUnit;
        MetricFactory<ContinuousMetric> durationMetricFactory = new HdrHistogramMetricFactory(
        ...
        runtimeMetrics = new MetricGroup<ContinuousMetric>( METRIC_RUNTIME, durationMetricFactory );
        startTimeDelayMetrics = new MetricGroup<ContinuousMetric>( METRIC_START_TIME_DELAY, durationMetricFactory );
    ...
    public MetricGroup<ContinuousMetric> getRuntimes()
    {
        return runtimeMetrics;
    }

    public MetricGroup<ContinuousMetric> getStartTimeDelays()
    {
    ...
    public void export( MetricsExporter metricsExporter,
            MetricFormatter<ContinuousMetric> hdrHistogramMetricsFormatter,
    ...
    public String[] getAllMeasuredOperationTypes()
    {
        ...
        {
            allOperationTypes.add( metric.name() );
        }
