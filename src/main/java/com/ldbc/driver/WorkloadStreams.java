...
public class WorkloadStreams {
    ...
    public static WorkloadStreams timeOffsetAndCompressWorkloadStreams(
        ...
        for (WorkloadStreamDefinition blockingStream : blockingStreams) {
            PeekingIterator<Operation> peekingBlockingDependencyOperationStream =
                    Iterators.peekingIterator(blockingStream.dependencyOperations());
            try {
            ...
            PeekingIterator<Operation> peekingBlockingNonDependencyOperationStream =
                    Iterators.peekingIterator(blockingStream.nonDependencyOperations());
            try {
    ...
    public static Tuple3<WorkloadStreams, Workload, Long> createNewWorkloadWithOffsetAndLimitedWorkloadStreams(
        ...
        ClassNameWorkloadFactory workloadFactory = new ClassNameWorkloadFactory(configuration.getWorkloadClassName());
    ...
    public static Tuple3<WorkloadStreams, Workload, Long> createNewWorkloadWithOffsetAndLimitedWorkloadStreams(
        ...
        long[] startForStream = limitsAndMinimumsForStream.getElement1();
        long[] limitForStream = limitsAndMinimumsForStream.getElement2();
        long minimumTimeStamp = limitsAndMinimumsForStream.getElement3();
