...
public class Query15EventStreamReader implements Iterator<Operation>
{
    private final Iterator<Object[]> csvRows;

    public Query15EventStreamReader( Iterator<Object[]> csvRows )
    {
    ...
    public Operation next()
    {
        ...
        Operation operation = new LdbcSnbBiQuery15(
    ...
    public static class Decoder implements CsvEventStreamReaderBasicCharSeeker.EventDecoder<Object[]>
    {
        ...
        */
                ...
                throws IOException
        {
            ...
            return new Object[]{country, LdbcSnbBiQuery15.DEFAULT_LIMIT};
        }
    }
}
