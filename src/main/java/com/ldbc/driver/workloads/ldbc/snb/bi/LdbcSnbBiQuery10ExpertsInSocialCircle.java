...
public class LdbcSnbBiQuery10ExpertsInSocialCircle extends Operation<List<LdbcSnbBiQuery10ExpertsInSocialCircleResult>>
{
    ...
    public LdbcSnbBiQuery10ExpertsInSocialCircle( long personId, String country, String tagClass, int
    ...
    public String toString() {
        return "LdbcSnbBiQuery10ExpertsInSocialCircle{" +
                "personId=" + personId +
                ", country='" + country + '\'' +
                ", tagClass='" + tagClass + '\'' +
    ...
    public boolean equals(Object o) {
        ...
        LdbcSnbBiQuery10ExpertsInSocialCircle that = (LdbcSnbBiQuery10ExpertsInSocialCircle) o;
    ...
    @Override
    public List<LdbcSnbBiQuery10ExpertsInSocialCircleResult> marshalResult( String serializedResults )
            throws SerializingMarshallingException
    {
        List<List<Object>> resultsAsList = SerializationUtil.marshalListOfLists( serializedResults );
        List<LdbcSnbBiQuery10ExpertsInSocialCircleResult> result = new ArrayList<>();
        for ( int i = 0; i < resultsAsList.size(); i++ )
        {
            ...
            result.add(
                    new LdbcSnbBiQuery10ExpertsInSocialCircleResult(
                            personId,
                            tagName,
                            messageCount
                    )
    ...
    {
        List<LdbcSnbBiQuery10ExpertsInSocialCircleResult> result =
                (List<LdbcSnbBiQuery10ExpertsInSocialCircleResult>) resultsObject;
        List<List<Object>> resultsFields = new ArrayList<>();
        for ( int i = 0; i < result.size(); i++ )
        {
            LdbcSnbBiQuery10ExpertsInSocialCircleResult row = result.get( i );
