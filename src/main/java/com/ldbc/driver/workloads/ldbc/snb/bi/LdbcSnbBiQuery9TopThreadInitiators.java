...
public class LdbcSnbBiQuery9TopThreadInitiators extends Operation<List<LdbcSnbBiQuery9TopThreadInitiatorsResult>>
{
    ...
    public LdbcSnbBiQuery9TopThreadInitiators( long startDate, long endDate, int limit )
    {
    ...
    {
        return "LdbcSnbBiQuery9TopThreadInitiators{" +
               "startDate=" + startDate +
               ", endDate=" + endDate +
               ", limit=" + limit +
               '}';
    ...
    public boolean equals( Object o )
    {
        ...
        LdbcSnbBiQuery9TopThreadInitiators that = (LdbcSnbBiQuery9TopThreadInitiators) o;
    ...
    @Override
    public List<LdbcSnbBiQuery9TopThreadInitiatorsResult> marshalResult( String serializedResults )
            throws SerializingMarshallingException
    {
        List<List<Object>> resultsAsList = SerializationUtil.marshalListOfLists( serializedResults );
        List<LdbcSnbBiQuery9TopThreadInitiatorsResult> result = new ArrayList<>();
        for ( int i = 0; i < resultsAsList.size(); i++ )
        {
            ...
            result.add(
                    new LdbcSnbBiQuery9TopThreadInitiatorsResult(
                            personId,
                            personFirstName,
                            personLastName,
                            threadCount,
    ...
    {
        List<LdbcSnbBiQuery9TopThreadInitiatorsResult> result =
                (List<LdbcSnbBiQuery9TopThreadInitiatorsResult>) resultsObject;
        List<List<Object>> resultsFields = new ArrayList<>();
        for ( int i = 0; i < result.size(); i++ )
        {
            LdbcSnbBiQuery9TopThreadInitiatorsResult row = result.get( i );
