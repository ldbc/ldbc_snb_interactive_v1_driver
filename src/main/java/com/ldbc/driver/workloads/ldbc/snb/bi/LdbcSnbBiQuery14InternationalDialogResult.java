...
public class LdbcSnbBiQuery14InternationalDialogResult
{
    ...
    public LdbcSnbBiQuery14InternationalDialogResult( long personId1, long personId2, String city1Name, int score )
    {
    ...
    public String toString() {
        return "LdbcSnbBiQuery14InternationalDialogResult{" +
                "personId1=" + personId1 +
                ", personId2=" + personId2 +
                ", city1Name='" + city1Name + '\'' +
                ", score=" + score +
    ...
    public boolean equals(Object o) {
        ...
        LdbcSnbBiQuery14InternationalDialogResult that = (LdbcSnbBiQuery14InternationalDialogResult) o;
