...
public class DummyLdbcSnbInteractiveDb extends Db {
    ...
    private static final List<LdbcQuery1Result> LDBC_QUERY_1_RESULTS = DummyLdbcSnbInteractiveOperationResultSets.read1Results();
    ...
    private static final List<LdbcQuery2Result> LDBC_QUERY_2_RESULTS = DummyLdbcSnbInteractiveOperationResultSets.read2Results();
    ...
    private static final List<LdbcQuery3Result> LDBC_QUERY_3_RESULTS = DummyLdbcSnbInteractiveOperationResultSets.read3Results();
    ...
    private static final List<LdbcQuery4Result> LDBC_QUERY_4_RESULTS = DummyLdbcSnbInteractiveOperationResultSets.read4Results();
    ...
    private static final List<LdbcQuery5Result> LDBC_QUERY_5_RESULTS = DummyLdbcSnbInteractiveOperationResultSets.read5Results();
    ...
    private static final List<LdbcQuery6Result> LDBC_QUERY_6_RESULTS = DummyLdbcSnbInteractiveOperationResultSets.read6Results();
    ...
    private static final List<LdbcQuery7Result> LDBC_QUERY_7_RESULTS = DummyLdbcSnbInteractiveOperationResultSets.read7Results();
    ...
    private static final List<LdbcQuery8Result> LDBC_QUERY_8_RESULTS = DummyLdbcSnbInteractiveOperationResultSets.read8Results();
    ...
    private static final List<LdbcQuery9Result> LDBC_QUERY_9_RESULTS = DummyLdbcSnbInteractiveOperationResultSets.read9Results();
    ...
    private static final List<LdbcQuery10Result> LDBC_QUERY_10_RESULTS = DummyLdbcSnbInteractiveOperationResultSets.read10Results();
    ...
    private static final List<LdbcQuery11Result> LDBC_QUERY_11_RESULTS = DummyLdbcSnbInteractiveOperationResultSets.read11Results();
    ...
    private static final List<LdbcQuery12Result> LDBC_QUERY_12_RESULTS = DummyLdbcSnbInteractiveOperationResultSets.read12Results();
    ...
    private static final LdbcQuery13Result LDBC_QUERY_13_RESULTS = DummyLdbcSnbInteractiveOperationResultSets.read13Results();
    ...
    private static final List<LdbcQuery14Result> LDBC_QUERY_14_RESULTS = DummyLdbcSnbInteractiveOperationResultSets.read14Results();
    ...
    private static final LdbcShortQuery1PersonProfileResult LDBC_SHORT_QUERY_1_RESULTS = DummyLdbcSnbInteractiveOperationResultSets.short1Results();
    ...
    private static final List<LdbcShortQuery2PersonPostsResult> LDBC_SHORT_QUERY_2_RESULTS = DummyLdbcSnbInteractiveOperationResultSets.short2Results();
    ...
    private static final List<LdbcShortQuery3PersonFriendsResult> LDBC_SHORT_QUERY_3_RESULTS = DummyLdbcSnbInteractiveOperationResultSets.short3Results();
    ...
    private static final LdbcShortQuery4MessageContentResult LDBC_SHORT_QUERY_4_RESULTS = DummyLdbcSnbInteractiveOperationResultSets.short4Results();
    ...
    private static final LdbcShortQuery5MessageCreatorResult LDBC_SHORT_QUERY_5_RESULTS = DummyLdbcSnbInteractiveOperationResultSets.short5Results();
    ...
    private static final LdbcShortQuery6MessageForumResult LDBC_SHORT_QUERY_6_RESULTS = DummyLdbcSnbInteractiveOperationResultSets.short6Results();
    ...
    private static final List<LdbcShortQuery7MessageRepliesResult> LDBC_SHORT_QUERY_7_RESULTS = DummyLdbcSnbInteractiveOperationResultSets.short7Results();
