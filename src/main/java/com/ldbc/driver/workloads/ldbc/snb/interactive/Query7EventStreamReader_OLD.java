...
public class Query7EventStreamReader_OLD implements Iterator<Operation<?>> {
    ...
    public static final CsvEventStreamReader_OLD.EventDecoder<Operation<?>> EVENT_DECODER = new CsvEventStreamReader_OLD.EventDecoder<Operation<?>>() {
        ...
        public Operation<?> decodeEvent(String[] csvRow) {
            ...
            return new LdbcQuery7(personId, personUri, LdbcQuery7.DEFAULT_LIMIT);
        }
    };

    public Query7EventStreamReader_OLD(Iterator<String[]> csvRowIterator) {
        this(csvRowIterator, CsvEventStreamReader_OLD.EventReturnPolicy.AT_LEAST_ONE_MATCH);
    }

    public Query7EventStreamReader_OLD(Iterator<String[]> csvRowIterator, CsvEventStreamReader_OLD.EventReturnPolicy eventReturnPolicy) {
