...
public class LdbcSnbBiQuery13ZombiesResult
{
    ...
    public LdbcSnbBiQuery13ZombiesResult(long personId, int zombieLikeCount, int totalLikeCount, double zombieScore)
    {
    ...
    {
        return "LdbcSnbBiQuery13ZombiesResult{" +
               "personId=" + personId +
    ...
    public boolean equals( Object o )
    {
        ...
        LdbcSnbBiQuery13ZombiesResult that = (LdbcSnbBiQuery13ZombiesResult) o;
