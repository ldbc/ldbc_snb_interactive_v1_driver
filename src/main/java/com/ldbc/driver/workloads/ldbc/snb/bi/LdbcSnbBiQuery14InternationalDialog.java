...
public class LdbcSnbBiQuery14InternationalDialog extends Operation<List<LdbcSnbBiQuery14InternationalDialogResult>>
{
    ...
    public LdbcSnbBiQuery14InternationalDialog( String country1, String country2, int limit )
    {
    ...
    {
        return "LdbcSnbBiQuery14InternationalDialog{" +
               "country1='" + country1 + '\'' +
               ", country2='" + country2 + '\'' +
               ", limit=" + limit +
               '}';
    ...
    public boolean equals( Object o )
    {
        ...
        LdbcSnbBiQuery14InternationalDialog that = (LdbcSnbBiQuery14InternationalDialog) o;
    ...
    @Override
    public List<LdbcSnbBiQuery14InternationalDialogResult> marshalResult( String serializedResults ) throws
            SerializingMarshallingException
    {
        List<List<Object>> resultsAsList = SerializationUtil.marshalListOfLists( serializedResults );
        List<LdbcSnbBiQuery14InternationalDialogResult> result = new ArrayList<>();
        for ( int i = 0; i < resultsAsList.size(); i++ )
        {
            ...
            result.add(
                    new LdbcSnbBiQuery14InternationalDialogResult(
                            personId1,
                            personId2,
                            city1Name,
                            score
    ...
    {
        List<LdbcSnbBiQuery14InternationalDialogResult> result =
                (List<LdbcSnbBiQuery14InternationalDialogResult>) resultsObject;
        List<List<Object>> resultsFields = new ArrayList<>();
        for ( int i = 0; i < result.size(); i++ )
        {
            LdbcSnbBiQuery14InternationalDialogResult row = result.get( i );
