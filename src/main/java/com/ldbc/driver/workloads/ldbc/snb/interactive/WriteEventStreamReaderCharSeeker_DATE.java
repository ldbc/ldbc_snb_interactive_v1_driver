...
public class WriteEventStreamReaderCharSeeker_DATE implements Iterator<Operation<?>> {
    private final CsvEventStreamReaderCharSeeker<Operation<?>> csvEventStreamReader;

    public WriteEventStreamReaderCharSeeker_DATE(CharSeeker charSeeker, Extractors extractors, int columnDelimiter) {
