...
public class LdbcShortQuery3PersonFriends extends Operation<List<LdbcShortQuery3PersonFriendsResult>> {
    ...
    @Override
    public List<LdbcShortQuery3PersonFriendsResult> marshalResult(String serializedResult) throws SerializingMarshallingException {
    ...
    public String serializeResult(Object operationResultInstance) throws SerializingMarshallingException {
        List<LdbcShortQuery3PersonFriendsResult> results = (List<LdbcShortQuery3PersonFriendsResult>) operationResultInstance;
