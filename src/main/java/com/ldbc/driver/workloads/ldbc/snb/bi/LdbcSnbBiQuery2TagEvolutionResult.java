...
public class LdbcSnbBiQuery2TagEvolutionResult
{
    ...
    public LdbcSnbBiQuery2TagEvolutionResult(
            String tagName,
            int countMonth1,
            int countMonth2,
            int diff)
    ...
    {
        return "LdbcSnbBiQuery2TagEvolutionResult{" +
               "tagName='" + tagName + '\'' +
    ...
    public boolean equals( Object o )
    {
        ...
        LdbcSnbBiQuery2TagEvolutionResult that = (LdbcSnbBiQuery2TagEvolutionResult) o;
