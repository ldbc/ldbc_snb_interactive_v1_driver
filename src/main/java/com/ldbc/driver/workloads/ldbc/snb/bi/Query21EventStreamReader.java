...
public class Query21EventStreamReader implements Iterator<Operation>
{
    private final Iterator<Object[]> csvRows;

    public Query21EventStreamReader( Iterator<Object[]> csvRows )
    {
    ...
    public Operation next()
    {
        ...
        Operation operation = new LdbcSnbBiQuery21(
    ...
    public static class Decoder implements CsvEventStreamReaderBasicCharSeeker.EventDecoder<Object[]>
    {
        ...
        */
                ...
                throws IOException
        {
            ...
            return new Object[]{country, LdbcSnbBiQuery21.DEFAULT_LIMIT};
        }
    }
}
