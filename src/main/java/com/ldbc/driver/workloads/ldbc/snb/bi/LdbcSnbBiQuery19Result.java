...
public class LdbcSnbBiQuery19Result
{
    private final long personId;
    private final int strangerCount;
    private final int count;

    public LdbcSnbBiQuery19Result( long personId, int strangerCount, int count )
    {
    ...
    public boolean equals( Object o )
    {
        ...
        LdbcSnbBiQuery19Result that = (LdbcSnbBiQuery19Result) o;
