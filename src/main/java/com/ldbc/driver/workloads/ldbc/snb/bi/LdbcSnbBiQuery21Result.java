...
public class LdbcSnbBiQuery21Result
{
    ...
    public LdbcSnbBiQuery21Result( long personId, int zombieCount, int realCount, int score )
    {
    ...
    public boolean equals( Object o )
    {
        ...
        LdbcSnbBiQuery21Result that = (LdbcSnbBiQuery21Result) o;
