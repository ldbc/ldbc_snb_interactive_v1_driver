...
public class PoolingOperationHandlerRunnerFactory implements OperationHandlerRunnerFactory {
    ...
    public PoolingOperationHandlerRunnerFactory(OperationHandlerRunnerFactory operationHandlerRunnerFactory) {
        ...
        OperationHandlerRunnerAllocator operationHandlerRunnerAllocator = new OperationHandlerRunnerAllocator(innerOperationHandlerRunnerFactory);
    ...
    public OperationHandlerRunnableContext newOperationHandlerRunner() throws OperationException {
        try {
            OperationHandlerRunnableContext operationHandlerRunner = operationHandlerRunnerPool.claim(POOL_CLAIM_TIMEOUT);
            ...
            throw new OperationException(
                    String.format("Error encountered while attempting to allocate handler runner from pool\n"
                                    + "Max pool size: %s\n"
...
//                                operationHandlerRunnerPool.getReallocationFailureLatencyPercentile(100)
    ...
    public String toString() {
        return PoolingOperationHandlerRunnerFactory.class.getSimpleName() + "{" + innerOperationHandlerRunnerFactory.toString() + "}";
    }
    ...
    private static class OperationHandlerRunnerAllocator implements Allocator<OperationHandlerRunnableContext> {
        ...
        public OperationHandlerRunnableContext allocate(Slot slot) throws Exception {
            OperationHandlerRunnableContext operationHandlerRunner = operationHandlerRunnerFactory.newOperationHandlerRunner();
