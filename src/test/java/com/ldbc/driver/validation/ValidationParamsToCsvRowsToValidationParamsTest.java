...
public class ValidationParamsToCsvRowsToValidationParamsTest {
    ...
    @Test
    public void validationParametersShouldBeUnchangedAfterSerializingAndMarshalling() throws IOException, DriverConfigurationException, WorkloadException {
        ...
        // (1) params
        List<ValidationParam> validationParamsBeforeSerializing = buildParams(workload.dbValidationParametersFilter(0));
    ...
    List<ValidationParam> buildParams(Workload.DbValidationParametersFilter dbValidationParametersFilter) {
        ...
        LdbcShortQuery1PersonProfileResult shortReadResult1 = DummyLdbcSnbInteractiveOperationResultInstances.short1Result();
        ...
        LdbcShortQuery4MessageContentResult shortReadResult4 = DummyLdbcSnbInteractiveOperationResultInstances.short4Result();
        ...
        LdbcShortQuery5MessageCreatorResult shortReadResult5 = DummyLdbcSnbInteractiveOperationResultInstances.short5Result();
        ...
        LdbcShortQuery6MessageForumResult shortReadResult6 = DummyLdbcSnbInteractiveOperationResultInstances.short6Result();
