...
public class WorkloadStatisticsCalculatorTest {
    ...
    public void shouldReturnCorrectWorkloadStatisticsForWorkloadsWithSingleOperationType() throws MetricsCollectionException {
        ...
        assertThat(stats.lastStartTimesAsMilliByOperationType().get(TimedNamedOperation1.class), equalTo(workloadStartTime + expectedWorkloadDurationAsMilli));
    ...
    public void shouldReturnCorrectWorkloadStatisticsForWorkloadsWithMultipleOperationTypes() throws MetricsCollectionException {
        ...
        assertThat(stats.lastStartTimesAsMilliByOperationType().get(TimedNamedOperation1.class), equalTo(operation1StartTime + expectedWorkloadOperation1DurationAsMilli));
        assertThat(stats.lastStartTimesAsMilliByOperationType().get(TimedNamedOperation2.class), equalTo(operation2StartTime + expectedWorkloadOperation2DurationAsMilli));
        assertThat(stats.lastStartTimesAsMilliByOperationType().get(TimedNamedOperation3.class), equalTo(operation3StartTime + expectedWorkloadOperation3DurationAsMilli));
...
//        assertThat(Duration.fromMilli(Math.round(interleavesForDependentOperations.mean())), is());
        ...
        assertThat(stats.lowestDependencyDurationAsMilliByOperationType().get(TimedNamedOperation1.class), is(100l));
        assertThat(stats.lowestDependencyDurationAsMilliByOperationType().get(TimedNamedOperation2.class), is(100l));
        assertThat(stats.lowestDependencyDurationAsMilliByOperationType().get(TimedNamedOperation3.class), is(10l));
