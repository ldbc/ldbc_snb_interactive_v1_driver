...
public class InteractiveSerializeMarshalOperationResultsTest
{
    @Test
    public void ldbcQuery1ShouldSerializeAndMarshalResult() throws SerializingMarshallingException
    {
        ...
        Iterable<List<Object>> friendCompanies1 =
                Lists.<List<Object>>newArrayList( Lists.<Object>newArrayList( "1g", "1h", "1i" ) );
    ...
    public void ldbcQuery14ShouldSerializeAndMarshalResult() throws SerializingMarshallingException
    {
        ...
        List<LdbcQuery14Result> before =
                Lists.newArrayList( new LdbcQuery14Result( Lists.newArrayList( 1l, 2l ), 3d ) );
    ...
    public void ldbcShortQuery1ShouldSerializeAndMarshalLdbcShortQuery1Result() throws SerializingMarshallingException
    {
        ...
        LdbcShortQuery1PersonProfileResult before =
                new LdbcShortQuery1PersonProfileResult( "a", "b", 1, "c", "d", 5, "e", 6 );
    ...
    public void ldbcShortQuery2ShouldSerializeAndMarshalLdbcShortQuery2Result() throws SerializingMarshallingException
    {
        ...
        List<LdbcShortQuery2PersonPostsResult> before = Lists.newArrayList(
                new LdbcShortQuery2PersonPostsResult( 1, "a", 3, 5, 7, "c", "e" ),
                new LdbcShortQuery2PersonPostsResult( 2, "b", 4, 6, 8, "d", "f" )
        );
