...
public class LdbcInteractiveWorkloadReadTests {
    ...
    static Map<String, String> defaultSnbParamsMap() {
        ...
        params.put(ConsoleAndFileDriverConfiguration.WORKLOAD_ARG, LdbcInteractiveWorkload.class.getName());
        params.put(ConsoleAndFileDriverConfiguration.RESULT_FILE_PATH_ARG, "test_ldbc_socnet_interactive_results.json");
        // LDBC Interactive Workload-specific parameters
        params.put(LdbcInteractiveWorkload.READ_OPERATION_1_INTERLEAVE_KEY, "30");
        params.put(LdbcInteractiveWorkload.READ_OPERATION_2_INTERLEAVE_KEY, "12");
        params.put(LdbcInteractiveWorkload.READ_OPERATION_3_INTERLEAVE_KEY, "72");
        params.put(LdbcInteractiveWorkload.READ_OPERATION_4_INTERLEAVE_KEY, "27");
        params.put(LdbcInteractiveWorkload.READ_OPERATION_5_INTERLEAVE_KEY, "42");
        params.put(LdbcInteractiveWorkload.READ_OPERATION_6_INTERLEAVE_KEY, "18");
        params.put(LdbcInteractiveWorkload.READ_OPERATION_7_INTERLEAVE_KEY, "13");
        params.put(LdbcInteractiveWorkload.READ_OPERATION_8_INTERLEAVE_KEY, "1");
        params.put(LdbcInteractiveWorkload.READ_OPERATION_9_INTERLEAVE_KEY, "40");
        params.put(LdbcInteractiveWorkload.READ_OPERATION_10_INTERLEAVE_KEY, "27");
        params.put(LdbcInteractiveWorkload.READ_OPERATION_11_INTERLEAVE_KEY, "18");
        params.put(LdbcInteractiveWorkload.READ_OPERATION_12_INTERLEAVE_KEY, "34");
        params.put(LdbcInteractiveWorkload.READ_OPERATION_13_INTERLEAVE_KEY, "1");
        params.put(LdbcInteractiveWorkload.READ_OPERATION_14_INTERLEAVE_KEY, "66");
        params.put(LdbcInteractiveWorkload.READ_OPERATION_1_ENABLE_KEY, "true");
        params.put(LdbcInteractiveWorkload.READ_OPERATION_2_ENABLE_KEY, "true");
        params.put(LdbcInteractiveWorkload.READ_OPERATION_3_ENABLE_KEY, "true");
        params.put(LdbcInteractiveWorkload.READ_OPERATION_4_ENABLE_KEY, "true");
        params.put(LdbcInteractiveWorkload.READ_OPERATION_5_ENABLE_KEY, "true");
        params.put(LdbcInteractiveWorkload.READ_OPERATION_6_ENABLE_KEY, "true");
        params.put(LdbcInteractiveWorkload.READ_OPERATION_7_ENABLE_KEY, "true");
        params.put(LdbcInteractiveWorkload.READ_OPERATION_8_ENABLE_KEY, "true");
        params.put(LdbcInteractiveWorkload.READ_OPERATION_9_ENABLE_KEY, "true");
        params.put(LdbcInteractiveWorkload.READ_OPERATION_10_ENABLE_KEY, "true");
        params.put(LdbcInteractiveWorkload.READ_OPERATION_11_ENABLE_KEY, "true");
        params.put(LdbcInteractiveWorkload.READ_OPERATION_12_ENABLE_KEY, "true");
        params.put(LdbcInteractiveWorkload.READ_OPERATION_13_ENABLE_KEY, "true");
        params.put(LdbcInteractiveWorkload.READ_OPERATION_14_ENABLE_KEY, "true");
        params.put(LdbcInteractiveWorkload.WRITE_OPERATION_1_ENABLE_KEY, "false");
        params.put(LdbcInteractiveWorkload.WRITE_OPERATION_2_ENABLE_KEY, "false");
        params.put(LdbcInteractiveWorkload.WRITE_OPERATION_3_ENABLE_KEY, "false");
        params.put(LdbcInteractiveWorkload.WRITE_OPERATION_4_ENABLE_KEY, "false");
        params.put(LdbcInteractiveWorkload.WRITE_OPERATION_5_ENABLE_KEY, "false");
        params.put(LdbcInteractiveWorkload.WRITE_OPERATION_6_ENABLE_KEY, "false");
        params.put(LdbcInteractiveWorkload.WRITE_OPERATION_7_ENABLE_KEY, "false");
        params.put(LdbcInteractiveWorkload.WRITE_OPERATION_8_ENABLE_KEY, "false");
    ...
    static Map<String, String> defaultSnbParamsMapWithWorkloadAndParametersDir() {
        ...
        additionalParams.put(LdbcInteractiveWorkload.PARAMETERS_DIRECTORY, TestUtils.getResource("/").getAbsolutePath());
    ...
    public void shouldGenerateConfiguredQueryMix() throws ClientException, DriverConfigurationException, WorkloadException, IOException {
        ...
        changedQueryMixParams.put(LdbcInteractiveWorkload.READ_OPERATION_1_INTERLEAVE_KEY, "100");
        changedQueryMixParams.put(LdbcInteractiveWorkload.READ_OPERATION_2_INTERLEAVE_KEY, "200");
        changedQueryMixParams.put(LdbcInteractiveWorkload.READ_OPERATION_3_INTERLEAVE_KEY, "400");
        changedQueryMixParams.put(LdbcInteractiveWorkload.READ_OPERATION_4_INTERLEAVE_KEY, "800");
        changedQueryMixParams.put(LdbcInteractiveWorkload.READ_OPERATION_5_INTERLEAVE_KEY, "1600");
        changedQueryMixParams.put(LdbcInteractiveWorkload.READ_OPERATION_6_INTERLEAVE_KEY, "1600");
        changedQueryMixParams.put(LdbcInteractiveWorkload.READ_OPERATION_7_INTERLEAVE_KEY, "800");
        changedQueryMixParams.put(LdbcInteractiveWorkload.READ_OPERATION_8_INTERLEAVE_KEY, "800");
        changedQueryMixParams.put(LdbcInteractiveWorkload.READ_OPERATION_9_INTERLEAVE_KEY, "400");
        changedQueryMixParams.put(LdbcInteractiveWorkload.READ_OPERATION_10_INTERLEAVE_KEY, "200");
        changedQueryMixParams.put(LdbcInteractiveWorkload.READ_OPERATION_11_INTERLEAVE_KEY, "200");
        changedQueryMixParams.put(LdbcInteractiveWorkload.READ_OPERATION_12_INTERLEAVE_KEY, "200");
        changedQueryMixParams.put(LdbcInteractiveWorkload.READ_OPERATION_13_INTERLEAVE_KEY, "100");
        changedQueryMixParams.put(LdbcInteractiveWorkload.READ_OPERATION_14_INTERLEAVE_KEY, "100");
