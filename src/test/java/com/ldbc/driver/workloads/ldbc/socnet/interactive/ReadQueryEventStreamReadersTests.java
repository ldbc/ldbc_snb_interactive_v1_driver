...
public class ReadQueryEventStreamReadersTests {
    ...
    public void shouldParseAllQuery3Events() throws IOException, ParseException {
        ...
        assertThat(operation.countryX(), is("Taiwan"));
        assertThat(operation.countryY(), is("Bulgaria"));
        assertThat(operation.durationMillis(), is(53L * 24 * 60 * 60 * 1000));
        calendar.clear();
        ...
        assertThat(operation.countryX(), is("Nicaragua"));
        assertThat(operation.countryY(), is("Afghanistan"));
        assertThat(operation.durationMillis(), is(64L * 24 * 60 * 60 * 1000));
        calendar.clear();
        ...
        assertThat(operation.countryX(), is("Colombia"));
        assertThat(operation.countryY(), is("Lithuania"));
        assertThat(operation.durationMillis(), is(58L * 24 * 60 * 60 * 1000));
        calendar.clear();
        ...
        assertThat(operation.countryX(), is("Lithuania"));
        assertThat(operation.countryY(), is("Afghanistan"));
        assertThat(operation.durationMillis(), is(53L * 24 * 60 * 60 * 1000));
        calendar.clear();
    ...
    public void shouldParseAllQuery4Events() throws IOException, ParseException {
        ...
        assertThat(operation.durationMillis(), is(43L * 24 * 60 * 60 * 1000));
        calendar.clear();
        ...
        assertThat(operation.durationMillis(), is(36L * 24 * 60 * 60 * 1000));
        calendar.clear();
        ...
        assertThat(operation.durationMillis(), is(57L * 24 * 60 * 60 * 1000));
        calendar.clear();
        ...
        assertThat(operation.durationMillis(), is(81L * 24 * 60 * 60 * 1000));
        calendar.clear();
        calendar.set(2011, Calendar.JULY, 1);
        assertThat(operation.minDate().getTime(), is(calendar.getTime().getTime()));
