...
public class ReadQueryEventStreamReadersTestData {
    ...
    public static final String QUERY_2_CSV_ROWS() throws ParseException {
        return ""
                + "12094628092905|" + dateFormat.parse("2013-01-28").getTime() + "\n"
                + "9895606011404|" + dateFormat.parse("2013-01-28").getTime() + "\n"
                + "14293651244033|" + dateFormat.parse("2013-02-2").getTime() + "\n"
                + "13194139602632|" + dateFormat.parse("2013-10-16").getTime();
    }

    public static final String QUERY_3_CSV_ROWS() throws ParseException {
        return ""
                + "9895605643992|" + dateFormat.parse("2011-12-1").getTime() + "|53|Taiwan|Bulgaria\n"
                + "979201|" + dateFormat.parse("2012-4-1").getTime() + "|64|Nicaragua|Afghanistan\n"
                + "129891|" + dateFormat.parse("2011-05-1").getTime() + "|58|Colombia|Lithuania\n"
                + "13194140498760|" + dateFormat.parse("2010-12-1").getTime() + "|53|Lithuania|Afghanistan";
    }

    public static final String QUERY_4_CSV_ROWS() throws ParseException {
        return ""
                + "12094628092905|" + dateFormat.parse("2011-4-1").getTime() + "|43\n"
                + "9895606011404|" + dateFormat.parse("2012-1-1").getTime() + "|36\n"
                + "14293651244033|" + dateFormat.parse("2011-7-1").getTime() + "|57\n"
                + "13194139602632|" + dateFormat.parse("2011-7-1").getTime() + "|81\n";
    }

    public static final String QUERY_5_CSV_ROWS() throws ParseException {
        return ""
                + "9895605643992|" + dateFormat.parse("2012-12-15").getTime() + "\n"
                + "979201|" + dateFormat.parse("2012-12-16").getTime() + "\n"
                + "129891|" + dateFormat.parse("2012-12-14").getTime() + "\n"
                + "13194140498760|" + dateFormat.parse("2012-12-12").getTime();
    }
    ...
    public static final String QUERY_9_CSV_ROWS() throws ParseException {
        return ""
                + "9895605643992|" + dateFormat.parse("2011-12-22").getTime() + "\n"
                + "979201|" + dateFormat.parse("2011-11-19").getTime() + "\n"
                + "129891|" + dateFormat.parse("2011-11-20").getTime() + "\n"
                + "13194140498760|" + dateFormat.parse("2011-12-1").getTime();
    }
