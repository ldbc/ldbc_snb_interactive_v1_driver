...
public class InteractiveWorkloadTest
{
    @Rule
    ...
    public void shouldBeAbleToSerializeAndMarshalAllOperations() throws SerializingMarshallingException
    {
        ...
        // Then
        assertThat( workload.marshalOperation( serializedRead1 ), equalTo( (Operation) read1 ) );
        assertThat( workload.marshalOperation( serializedRead2 ), equalTo( (Operation) read2 ) );
        assertThat( workload.marshalOperation( serializedRead3 ), equalTo( (Operation) read3 ) );
        assertThat( workload.marshalOperation( serializedRead4 ), equalTo( (Operation) read4 ) );
        assertThat( workload.marshalOperation( serializedRead5 ), equalTo( (Operation) read5 ) );
        assertThat( workload.marshalOperation( serializedRead6 ), equalTo( (Operation) read6 ) );
        assertThat( workload.marshalOperation( serializedRead7 ), equalTo( (Operation) read7 ) );
        assertThat( workload.marshalOperation( serializedRead8 ), equalTo( (Operation) read8 ) );
        assertThat( workload.marshalOperation( serializedRead9 ), equalTo( (Operation) read9 ) );
        assertThat( workload.marshalOperation( serializedRead10 ), equalTo( (Operation) read10 ) );
        assertThat( workload.marshalOperation( serializedRead11 ), equalTo( (Operation) read11 ) );
        assertThat( workload.marshalOperation( serializedRead12 ), equalTo( (Operation) read12 ) );
        assertThat( workload.marshalOperation( serializedRead13 ), equalTo( (Operation) read13 ) );
        assertThat( workload.marshalOperation( serializedRead14 ), equalTo( (Operation) read14 ) );

        assertThat( workload.marshalOperation( serializedShortRead1 ), equalTo( (Operation) shortRead1 ) );
        assertThat( workload.marshalOperation( serializedShortRead2 ), equalTo( (Operation) shortRead2 ) );
        assertThat( workload.marshalOperation( serializedShortRead3 ), equalTo( (Operation) shortRead3 ) );
        assertThat( workload.marshalOperation( serializedShortRead4 ), equalTo( (Operation) shortRead4 ) );
        assertThat( workload.marshalOperation( serializedShortRead5 ), equalTo( (Operation) shortRead5 ) );
        assertThat( workload.marshalOperation( serializedShortRead6 ), equalTo( (Operation) shortRead6 ) );
        assertThat( workload.marshalOperation( serializedShortRead7 ), equalTo( (Operation) shortRead7 ) );

        assertThat( workload.marshalOperation( serializedWrite1 ), equalTo( (Operation) write1 ) );
        assertThat( workload.marshalOperation( serializedWrite2 ), equalTo( (Operation) write2 ) );
        assertThat( workload.marshalOperation( serializedWrite3 ), equalTo( (Operation) write3 ) );
        assertThat( workload.marshalOperation( serializedWrite4 ), equalTo( (Operation) write4 ) );
        assertThat( workload.marshalOperation( serializedWrite5 ), equalTo( (Operation) write5 ) );
        assertThat( workload.marshalOperation( serializedWrite6 ), equalTo( (Operation) write6 ) );
        assertThat( workload.marshalOperation( serializedWrite7 ), equalTo( (Operation) write7 ) );
        assertThat( workload.marshalOperation( serializedWrite8 ), equalTo( (Operation) write8 ) );
    }
            ...
            throws ClientException, DriverConfigurationException, WorkloadException, IOException
    {
        ...
        ConsoleAndFileDriverConfiguration params = ConsoleAndFileDriverConfiguration.fromArgs( new String[]{
                ...
                "-p", LdbcSnbInteractiveWorkloadConfiguration.UPDATES_DIRECTORY,
                TestUtils.getResource( "/snb/interactive/" ).getAbsolutePath(),
    ...
    public void shouldLoadFromConfigFile() throws DriverConfigurationException, ClientException, IOException
    {
        ...
        String updateStreamPropertiesPath =
                TestUtils.getResource( "/snb/interactive/updateStream.properties" ).getAbsolutePath();
        String resultDirPath = temporaryFolder.newFolder().getAbsolutePath();
...
//                "-p", LdbcSnbInteractiveConfiguration.SAFE_T, "1",
            ...
            throws WorkloadException, DriverConfigurationException
    {
        ...
        assertThat( params.asMap().get( LdbcSnbInteractiveWorkloadConfiguration.READ_OPERATION_1_INTERLEAVE_KEY ),
                equalTo(
                        Long.toString(
                                Long.parseLong( LdbcSnbInteractiveWorkloadConfiguration.DEFAULT_UPDATE_INTERLEAVE ) *
                                10 ) ) );
        assertThat( params.asMap().get( LdbcSnbInteractiveWorkloadConfiguration.READ_OPERATION_2_INTERLEAVE_KEY ),
                equalTo(
                        Long.toString(
