...
public class BoundedBufferTest
{
    ...
    public void evictingQueuePerformanceTest()
    {
        ...
        System.out.println(
                format( "%s added %s things in %s = %s things/ms",
        ...
        System.out.println(
                format( "Synchronized %s added %s things in %s = %s things/ms",
                        queue.getClass().getSimpleName(),
                        INTEGRAL_FORMAT.format( count ),
                        TEMPORAL_UTIL.nanoDurationToString( nanoStop - nanoStart ),
                        DECIMAL_FORMAT.format( (count / (double) (nanoStop - nanoStart) * 1000000) )
    ...
    public void evictingQueueAddRemovePerformanceTest()
    {
        ...
        System.out.println(
                format( "%s added/removed %s things in %s = %s things/ms",
                        queue.getClass().getSimpleName(),
                        INTEGRAL_FORMAT.format( count ),
                        TEMPORAL_UTIL.nanoDurationToString( nanoStop - nanoStart ),
                        DECIMAL_FORMAT.format( (count / (double) (nanoStop - nanoStart) * 1000000) )
        ...
        System.out.println(
                format( "Synchronized %s added/removed %s things in %s = %s things/ms",
                        queue.getClass().getSimpleName(),
                        INTEGRAL_FORMAT.format( count ),
                        TEMPORAL_UTIL.nanoDurationToString( nanoStop - nanoStart ),
                        DECIMAL_FORMAT.format( (count / (double) (nanoStop - nanoStart) * 1000000) )
