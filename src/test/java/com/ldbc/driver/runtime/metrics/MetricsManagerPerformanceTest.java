...
public class MetricsManagerPerformanceTest {
    ...
    final static LdbcShortQuery7MessageReplies LDBC_SHORT_QUERY_7_MESSAGE_REPLIES = new LdbcShortQuery7MessageReplies(1);
    final static LdbcUpdate1AddPerson LDBC_UPDATE_1_ADD_PERSON = new LdbcUpdate1AddPerson(1, null, null, null, null, null, null, null, 2, null, null, null, null, null);
    ...
    final static LdbcUpdate5AddForumMembership LDBC_UPDATE_5_ADD_FORUM_MEMBERSHIP = new LdbcUpdate5AddForumMembership(1, 2, null);
    final static LdbcUpdate6AddPost LDBC_UPDATE_6_ADD_POST = new LdbcUpdate6AddPost(1, null, null, null, null, null, null, 2, 3, 4, 5, null);
    final static LdbcUpdate7AddComment LDBC_UPDATE_7_ADD_COMMENT = new LdbcUpdate7AddComment(1, null, null, null, null, 2, 3, 4, 5, 6, null);
    ...
    JCTools MPSC: Bounded Non-Blocking - LockSupport.parkNanos(1)
        ...
        ThreadedQueuedConcurrentMetricsService 4 threads 1,000,000,000 operations in 01:21.476.000 (m:s.ms.us) --> 12,273,553 op/s
        ThreadedQueuedConcurrentMetricsService 8 threads 1,000,000,000 operations in 02:01.303.000 (m:s.ms.us) --> 8,243,819 op/s
