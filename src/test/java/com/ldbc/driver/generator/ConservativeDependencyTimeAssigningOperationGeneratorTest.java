...
public class ConservativeDependencyTimeAssigningOperationGeneratorTest {
    ...
    public void testAssignDependencyTimesEqualToLastEncounteredLowerDependencyStartTime() {
        ...
        Iterator<Operation<?>> operationsWithDependencyTimes =
                gf.assignDependencyTimesEqualToLastEncounteredLowerDependencyTimeStamp(operations, isDependency, initialDependencyTime, canOverwriteDependencyTime);
    ...
    public void testAssignDependencyTimesEqualToLastEncounteredDependencyStartTime() {
        ...
        // When
        Iterator<Operation<?>> operationsWithDependencyTimes =
                gf.assignDependencyTimesEqualToLastEncounteredDependencyTimeStamp(operations, isDependency, initialDependencyTime, canOverwriteDependencyTime);
