...
public class InteractiveReadEventStreamReadersTest
{
    ...
    public void shouldParseAllQuery1Events() throws WorkloadException, SQLException {
        ...
        QueryEventStreamDecoder.EventDecoder<Object[]> decoder = new Query1EventStreamReader.QueryDecoder();
    ...
    public void shouldParseAllQuery2Events() throws WorkloadException, SQLException, ParseException {
        ...
        QueryEventStreamDecoder.EventDecoder<Object[]> decoder = new Query2EventStreamReader.QueryDecoder();
        CsvLoader loader = new CsvLoader(db);
        Iterator<Object[]> opStream = loader.loadOperationStream("/somepath", '|', decoder);
    ...
    public void shouldParseAllQuery3Events() throws WorkloadException, SQLException, ParseException {
        ...
        QueryEventStreamDecoder.EventDecoder<Object[]> decoder = new Query3EventStreamReader.QueryDecoder();
        CsvLoader loader = new CsvLoader(db);
        Iterator<Object[]> opStream = loader.loadOperationStream("/somepath", '|', decoder);
        Calendar calendar = Calendar.getInstance();
        calendar.setTimeZone(TimeZone.getTimeZone("GMT"));
    ...
    public void shouldParseAllQuery4Events() throws WorkloadException, SQLException, ParseException {
        ...
        when(rs.getInt(3))
            ...
            .thenReturn(57)
            .thenReturn(81);
        QueryEventStreamDecoder.EventDecoder<Object[]> decoder = new Query4EventStreamReader.QueryDecoder();
        CsvLoader loader = new CsvLoader(db);
        Iterator<Object[]> opStream = loader.loadOperationStream("/somepath", '|', decoder);
        Calendar calendar = Calendar.getInstance();
        calendar.setTimeZone(TimeZone.getTimeZone("GMT"));
    ...
    public void shouldParseAllQuery5Events() throws WorkloadException, SQLException, ParseException {
        ...
        QueryEventStreamDecoder.EventDecoder<Object[]> decoder = new Query5EventStreamReader.QueryDecoder();
        CsvLoader loader = new CsvLoader(db);
        Iterator<Object[]> opStream = loader.loadOperationStream("/somepath", '|', decoder);
        Calendar calendar = Calendar.getInstance();
        calendar.setTimeZone(TimeZone.getTimeZone("GMT"));
    ...
    public void shouldParseAllQuery6Events() throws WorkloadException, SQLException {
        ...
        when(rs.getLong(1))
            ...
            .thenReturn(129891l)
            .thenReturn(13194140498760l);
        QueryEventStreamDecoder.EventDecoder<Object[]> decoder = new Query6EventStreamReader.QueryDecoder();
        CsvLoader loader = new CsvLoader(db);
        Iterator<Object[]> opStream = loader.loadOperationStream("/somepath", '|', decoder);
    ...
    public void shouldParseAllQuery7Events() throws WorkloadException, SQLException{
        ...
        QueryEventStreamDecoder.EventDecoder<Object[]> decoder = new Query7EventStreamReader.QueryDecoder();
        CsvLoader loader = new CsvLoader(db);
        Iterator<Object[]> opStream = loader.loadOperationStream("/somepath", '|', decoder);
        // Act
    ...
    public void shouldParseAllQuery8Events() throws WorkloadException, SQLException {
        ...
        QueryEventStreamDecoder.EventDecoder<Object[]> decoder = new Query8EventStreamReader.QueryDecoder();
        CsvLoader loader = new CsvLoader(db);
        Iterator<Object[]> opStream = loader.loadOperationStream("/somepath", '|', decoder);
        // Act
    ...
    public void shouldParseAllQuery9Events() throws WorkloadException, SQLException, ParseException {
        ...
        when(rs.getLong(2))
            ...
            .thenReturn(DATE_FORMAT.parse( "2011-12-1" ).getTime());
        QueryEventStreamDecoder.EventDecoder<Object[]> decoder = new Query9EventStreamReader.QueryDecoder();
        CsvLoader loader = new CsvLoader(db);
        Iterator<Object[]> opStream = loader.loadOperationStream("/somepath", '|', decoder);
        Calendar calendar = Calendar.getInstance();
        calendar.setTimeZone(TimeZone.getTimeZone("GMT"));
    ...
    public void shouldParseAllQuery10Events() throws WorkloadException, SQLException {
        ...
        when(rs.getLong(1))
            ...
            .thenReturn(129891l)
            .thenReturn(13194140498760l);
        QueryEventStreamDecoder.EventDecoder<Object[]> decoder = new Query10EventStreamReader.QueryDecoder();
        CsvLoader loader = new CsvLoader(db);
        Iterator<Object[]> opStream = loader.loadOperationStream("/somepath", '|', decoder);
    ...
    public void shouldParseAllQuery11Events() throws WorkloadException, SQLException {
        ...
        when(rs.getLong(1))
            ...
            .thenReturn(129891l)
            .thenReturn(13194140498760l);
        QueryEventStreamDecoder.EventDecoder<Object[]> decoder = new Query11EventStreamReader.QueryDecoder();
        CsvLoader loader = new CsvLoader(db);
        Iterator<Object[]> opStream = loader.loadOperationStream("/somepath", '|', decoder);
    ...
    public void shouldParseAllQuery12Events() throws WorkloadException, SQLException {
        ...
        when(rs.getLong(1))
            ...
            .thenReturn(14293651244033l)
            .thenReturn(13194139602632l);
        QueryEventStreamDecoder.EventDecoder<Object[]> decoder = new Query12EventStreamReader.QueryDecoder();
        CsvLoader loader = new CsvLoader(db);
        Iterator<Object[]> opStream = loader.loadOperationStream("/somepath", '|', decoder);
    ...
    public void shouldParseAllQuery13Events() throws WorkloadException, SQLException {
        ...
        QueryEventStreamDecoder.EventDecoder<Object[]> decoder = new Query13EventStreamReader.QueryDecoder();
        CsvLoader loader = new CsvLoader(db);
        Iterator<Object[]> opStream = loader.loadOperationStream("/somepath", '|', decoder);
        // Act
    ...
    public void shouldParseAllQuery14Events() throws WorkloadException, SQLException {
        ...
        QueryEventStreamDecoder.EventDecoder<Object[]> decoder = new Query14EventStreamReader.QueryDecoder();
        CsvLoader loader = new CsvLoader(db);
        Iterator<Object[]> opStream = loader.loadOperationStream("/somepath", '|', decoder);
