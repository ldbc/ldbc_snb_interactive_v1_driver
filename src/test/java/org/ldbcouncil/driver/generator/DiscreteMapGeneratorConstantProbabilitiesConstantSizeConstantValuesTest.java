...
import org.ldbcouncil.driver.util.Bucket.DiscreteBucket;
...
public class DiscreteMapGeneratorConstantProbabilitiesConstantSizeConstantValuesTest extends
    ...
    public Iterator<Map<String, Long>> getGeneratorImpl(GeneratorFactory generatorFactory) {
        Tuple3<Double, String, Iterator<Long>> t1 = Tuple.tuple3(1.0, "1",
                (Iterator<Long>) generatorFactory.constant(1l));
        Tuple3<Double, String, Iterator<Long>> t2 = Tuple.tuple3(1.0, "2",
                (Iterator<Long>) generatorFactory.constant(2l));
        Tuple3<Double, String, Iterator<Long>> t3 = Tuple.tuple3(1.0, "3",
                (Iterator<Long>) generatorFactory.constant(3l));
